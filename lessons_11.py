...
file_name_out = "Homework/Random_symbols_11.txt"
...
with open(file_name_out, 'w') as file_txt:
  file_txt.write(generate_txt_data())
...
def generate_json_data() -> dict:
    ...
    json_data = {generate_key(): generate_values() for _ in range(json_data_length)}
    return json_data
